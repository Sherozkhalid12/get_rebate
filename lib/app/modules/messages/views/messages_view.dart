...
class MessagesView extends GetView<MessagesController> {
  ...
  Widget _buildConversationsList(BuildContext context) {
    ...
    // Show header with back button when navbar is hidden OR when user is an agent
    final shouldShowHeader = !isNavBarVisible || controller.isAgent;
    
    return Column(
      children: [
        // Header with back button - show when navbar is NOT visible (hidden) OR when user is an agent
