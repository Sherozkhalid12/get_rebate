...
class LoanOfficerReviewsView extends StatelessWidget {
  final LoanOfficerModel? officer;

  const LoanOfficerReviewsView({super.key, required this.officer});

  @override
  Widget build(BuildContext context) {
    final reviews = officer?.reviews ?? <LoanOfficerReview>[];
    final rating = reviews.isNotEmpty
        ? reviews.map((r) => r.rating).reduce((a, b) => a + b) / reviews.length
        : (officer?.rating ?? 0.0);
    final reviewCount = officer?.reviewCount ?? reviews.length;
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.star_rounded, color: AppTheme.lightGreen, size: 30),
                  ),
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                child: (review.reviewerProfile == null ||
                                    ...
                                    ? Icon(Icons.person, color: AppTheme.lightGreen)
                                    : null,
                              ),
